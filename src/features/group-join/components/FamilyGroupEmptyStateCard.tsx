  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center px-6 pt-28">
      ...
      <div
        ...
        className="bg-btn-default-bg mt-20 flex w-full cursor-pointer gap-3 rounded-lg pt-6 pb-5 pl-8"
      >
        <img src={inviteSvg} />
      ...
      <div
        ...
        className="bg-btn-default-bg mt-9 flex w-full cursor-pointer gap-3 rounded-lg border-2 border-dashed border-[var(--color-line)] pt-5 pb-6 pl-8"
      >
        <img src={plusSvg} />
        <div className="flex flex-col gap-1">
